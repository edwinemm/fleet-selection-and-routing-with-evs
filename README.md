...
Charging Infrastructure Deployment: Optimizes the quantity and location of private chargers (e.g., 50kW, 150kW) considering both CAPEX and OPEX.
...
Ensure all five Excel data files are in the same folder as the .jl scripts.

Open your terminal or command prompt, navigate to the folder, and execute: julia main.jl
